...
async function main() {
    try {
        ...
        let result = await contract.evaluateTransaction('queryAllCages');
        // let result = await contract.evaluateTransaction('QueryAssetsWithPagination', JSON.stringify(queryString), 10, '');
